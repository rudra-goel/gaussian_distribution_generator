...
def generate_compact_trig_lut(func_name, func, filename, num_entries=2**16, data_width=16):
...
def main():
    ...
    print("Trigonometric Lookup Table Generator")
    print("=" * 50)
    
    generate_compact_trig_lut("COSINE", np.cos, "cosine_lut_16bit.mif", num_entries=2**16, data_width=16)
    generate_compact_trig_lut("SINE", np.sin, "sine_lut_16bit.mif", num_entries=2**16, data_width=16)
